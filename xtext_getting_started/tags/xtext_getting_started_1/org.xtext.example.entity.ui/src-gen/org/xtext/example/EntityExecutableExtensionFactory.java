 ...
 * generated
 */
public class EntityExecutableExtensionFactory implements IExecutableExtensionFactory, IExecutableExtension {

	private Logger log = Logger.getLogger(EntityExecutableExtensionFactory.class);
	...
	public Object create() throws CoreException {
		org.xtext.example.internal.EntityActivator instance = org.xtext.example.internal.EntityActivator.getInstance();
		if (instance == null)
		...
		try {
			...
			final Injector injector = org.xtext.example.internal.EntityActivator.getInstance().getInjector("org.xtext.example.Entity");
